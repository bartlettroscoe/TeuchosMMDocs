...
reference-counted types {}\texttt{RCP} and {}\texttt{ArrayRCP} for
...
non-reference-counted types {}\texttt{Ptr} and {}\texttt{ArrayView}
(or {}\texttt{Array[RCP]::iterator}).  By using the types
{}\texttt{Ptr} and {}\texttt{ArrayView} (or
