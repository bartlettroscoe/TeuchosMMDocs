...
The class {}\ttt{Array} is a directly replacement for
...
different threads in a multi-threaded program.  The {}\ttt{RCP} class
...
borrowing form the {}\ttt{boost::shared\_ptr} implementation) when it
is needed.  The {}\ttt{RCP} class has been developed in the context of
...
best non-locking {}\ttt{boost::shared\_ptr} implementation imparts a
...
{}\ttt{RCP} objects thread safe in an entire program.  Multi-threading
...
be addressed soon in the {}\ttt{RCP} and {}\ttt{ArrayRCP} classes.
Until then, {}\ttt{boost::shared\_ptr} can be used in cases where
