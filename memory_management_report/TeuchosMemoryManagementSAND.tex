...
underlying {}\texttt{RCPNode} object.  The only restriction is that
you have to make the choice of what you want to embedd in the
...
{}\texttt{RCPNode} object is that it can be quite a bit more efficient
than using the ``extra data'' feature which requires more
runtime-support.
