...
for this behavior is that the statement {}\ttt{c\_ = createC(rcp(this,
false))} in the constructor {}\ttt{SomeClass()} creates a non-owing
{}\ttt{RCPNode} object {}\underline{before} the owning {}\ttt{RCPNode}
object is created by the client code {}\ttt{RCP<SomeClass> sc(new
SomeClass)}.  This violates Commandment {}\ref{cmnd:owning-rcp-first}
...
strong owning {}\ttt{RCPNode} object was not the first created.
