...
``DDD Matters Today'' in {}\cite{DomainDrivenDesignQuickly} for
instance).
...
there are defects, will be easier and safter to maintain, and will be
...
as described in Gotcha \#33 {}\cite{C++Gotchas03}.  I will not go into
great detail about what happens here, but converting from an array of
type {}\texttt{B} it a base of type {}\texttt{A} is almost always
asking for disaster because the alignment of the base type
{}\texttt{A} will be wrong according to the full type {}\texttt{B}
(again see {}\cite[Gotcha \#33]{C++Gotchas03} all the gory details).
As a result, for the second iteration {}\texttt{i=1}, the embedded
pointer in {}\texttt{a\_array[1].char\_ptr\_} is pointing to garbage
because on most 32 bit machines with most compilers, the address in
