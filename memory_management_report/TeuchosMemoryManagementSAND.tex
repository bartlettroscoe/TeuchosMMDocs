...
{\small\begin{verbatim}
  ...
  public:
    ...
    // Reference counting member functions (see Section ???)
    ...
  ...
  // Other common non-member functions (see Section ???)
  ...
...
{\small\begin{verbatim}
  ...
  // Common non-member functions (see Section ???)
  ...
...
{\small\begin{verbatim}
  ...
  // Other common nonmember functions (see Section ???)
  ...
\end{verbatim}}
\end{listing}
...
{}\ref{listing:TypicalC++Class-sci}?  First, there is the duplication
...
Listing {}\ref{listing:TypicalC++Class-sci} is that the {}\texttt{C}
...
Listing {}\ref{listing:TypicalC++Class-sci} gives the new refactored
class in Listing {}\ref{listing:TypicalC++Class-sci-refactored}.


\begin{listing}: Example of the use of the ``separate construction and
initialization'' idiom  \\
\label{listing:TypicalC++Class-sci-refactored}
{\small\begin{verbatim}
    ...
    void finalInitialization()
      {
        ...
        // Now, we can call virtual functions on SomeBaseClass (someBaseFunc())!
...
class in Listing {}\ref{listing:TypicalC++Class-sci-refactored}, first
...
{}\ref{listing:TypicalC++Class-sci-refactored} are described below.
...
{}\ref{listing:TypicalC++Class-sci-refactored}.  Most classes in a
complex program are higher-level classes where low-level perforamnce
