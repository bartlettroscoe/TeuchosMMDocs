...
object can exist for any object that is shared.  Figure ??? shows an
example of several {}\texttt{RCP} objects pointing to the same
concrete object of type {}\texttt{C} through different base class
interfaces.  If the programmer follows the idioms described in Section
??? and outlined in Appendix ???, it will always be the case that only
...
is destroyed, whatever comes first.
...
\label{sec:detection-other-invalid-usage}
%
...
%
{}\subsubsection{Performance tuning strategies}
%
