...
{}\ref{sec:conversions}, {}\ref{sec:reference-counting-machinary},
{}\ref{sec:debug-mode-runtime-checking}, and ???.
...
{}\texttt{Array} also supports better runtime debug output with better
...
ToDo: Discuss persisting and non-persisting views.

ToDo: Show refactored algorithm that uses Array and ArrayView to clean
up.
