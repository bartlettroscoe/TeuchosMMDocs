...
{}\texttt{boost:shared\_ptr}.

There are numerous other uses for extra data to fix nasty memory
management problems and you will just have to use your imagination.
However, in well designed software, there is no need for a feature
like this so count yourself lucky if you never need to use it.
