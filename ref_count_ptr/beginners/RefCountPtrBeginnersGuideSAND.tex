...
%
\SANDnum{SAND2004-3268 (Updated September 2010)}
\SANDprintDate{September 2010}
\SANDauthor{
...
% Below is a raw copy of what is in ../example/example_raw_cpp_pointers.cpp
{\small\begin{verbatim}
...
% Below is a raw copy if what is in ../example/example_ref_count_ptr.cpp
{\small\begin{verbatim}
